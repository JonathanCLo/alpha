#
# Created by gmakemake (Ubuntu Jul 25 2014) on Sun May 14 11:39:23 2017
#
...
CPP_FILES =	alpha.cpp execute.cpp fetch.cpp hardware.cpp hw_exec.cpp hw_fetch.cpp hw_issue.cpp hw_mem.cpp hw_read.cpp issue.cpp make_connections.cpp memory.cpp pipeline.cpp read.cpp run_simulation.cpp
C_FILES =	
PS_FILES =	
S_FILES =	
...
OBJFILES =	execute.o fetch.o hardware.o hw_exec.o hw_fetch.o hw_issue.o hw_mem.o hw_read.o issue.o make_connections.o memory.o pipeline.o read.o run_simulation.o 
